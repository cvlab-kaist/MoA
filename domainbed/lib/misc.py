...
class SplitIterator_:
    def __init__(self, test_envs,train_envs):
        self.test_envs = test_envs
        self.train_envs = train_envs

    def train(self, iterable, index=False):
        return index_conditional_iterate(lambda idx: idx in self.test_envs or idx not in self.train_envs, iterable, index)
